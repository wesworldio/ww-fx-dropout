...
class WesWorldReporter {
    ...
    init(
        serverURL: String = ProcessInfo.processInfo.environment["WW_LOGS_URL"] ?? "https://ww-logs.wesworld.workers.dev/api/logs",
        apiKey: String = ProcessInfo.processInfo.environment["WW_LOGS_API_KEY"] ?? "ww-fx-dropout-prod-2026-01-01",
